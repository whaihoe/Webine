...
| `MediaLibrary` | Admin upload and reusable asset workspace | Drag or button upload, 50 MB client and server validation, animated GIF preservation, progress, preview, metadata, focal point, all-reference archive protection and permanent Vercel Blob cleanup |
