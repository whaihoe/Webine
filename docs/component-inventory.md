...
| `MediaLibrary` | Admin upload and reusable asset workspace | Drag or button upload, 15 MB image and 30 MB MP4 client and server validation, animated GIF preservation, R2 processing state, display name, original filename, focal point, reference-aware archive protection and R2 cleanup |
