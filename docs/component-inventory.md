...
| `ProcessTimeline` | Semantic four-stage process with line fill, early point-contact intake, centred outlet geometry and node-timed card lift | Waiting, absorbing, active, complete, emitting and reverse |
