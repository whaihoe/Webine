...
Particle uniforms use a restrained damping value and the runway uses a 1.45 second scrub. Pointer scrolling uses a 1.35 smoothing value and 0.88 speed. Touch layouts use a small 0.12 smoothing value, which adds weight without heavily delaying direct input.
